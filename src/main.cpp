...
const char* team_names[address_count] PROGMEM = {
  "debug test", // debug
  "Glinda", // 1
  "Baby Mutant Ninja Hatchlings (BMNH)", // 2
  "TBD", // 4
  "Guido", // 6
  "Lebron James Fan Club", // 7
  "egg", // 8
  "Apoorv", // 10
  "shay and em", // 12
  "hanging by PLA thread (or K.S.)", // 13
  "Isaac", // 14
  "Team Wall Breakers", // 15
  "SEC", // 16
  "the team that fried the esp32", // 19
  "TEST FIX NAME", // 20
  "team dunce", // 21
  "gecko", // 23
  "OnePieceIsTrash", // 27
  "The Turtle", // 30
  "Raven", // 32
  "mongo2007", // SOMTECH (mongo2007)
  "SOMTECH DEXTER", // SOMTECH (SOMTECH DEXTER)
  "Uncertified Forklift", // SOMTECH (Uncertified Forklift)
};
...
const uint8_t address_list[address_count][6] PROGMEM = {
  ...
  {0xec, 0xe3, 0x34, 0x22, 0xb5, 0x7c}, // 7
  {0xec, 0xe3, 0x34, 0x22, 0xcf, 0x2c}, // 8
  {0x80, 0xf3, 0xda, 0x40, 0xdc, 0x10}, // 10
  {0x80, 0xf3, 0xda, 0x41, 0x00, 0x0c}, // 12
  {0x80, 0xf3, 0xda, 0x41, 0x51, 0xd4}, // 13
  ...
  {0x08, 0xb6, 0x1f, 0xb8, 0x64, 0x20}, // 32
  {0xec, 0xe3, 0x34, 0x21, 0x68, 0x6c}, // SOMTECH (mongo2007)
  {0x80, 0xf3, 0xda, 0x42, 0x9d, 0x40}, // SOMTECH (SOMTECH DEXTER)
  {0x80, 0xf3, 0xda, 0x41, 0x3f, 0x10}, // SOMTECH (Uncertified Forklift)
};
