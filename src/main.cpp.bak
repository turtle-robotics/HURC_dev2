...
const int address_count = 25; // total number of addresses in the list
...
const uint8_t address_list[address_count][6] PROGMEM = {
  ...
  {0xec, 0xe3, 0x34, 0x21, 0x47, 0xc4}, // 3
  ...
  {0xd4, 0xe9, 0xf4, 0xb3, 0x3b, 0x10}, // 10
  {0xd4, 0xe9, 0xf4, 0xb4, 0x11, 0x6c}, // 12
  {0xe0, 0x8c, 0xfe, 0x5d, 0x12, 0x08}, // 13
  {0xd4, 0xe9, 0xf4, 0xb3, 0x51, 0x94}, // 14
  {0x40, 0x22, 0xd8, 0x59, 0x53, 0xfc}, // 17
  {0xd4, 0xe9, 0xf4, 0xbc, 0xd3, 0xe0}, // 18
  {0xd4, 0xe9, 0xf4, 0xb2, 0xd2, 0x34}, // 19
  {0xec, 0xe3, 0x34, 0x22, 0xf7, 0x9c}, // 20
  {0xd4, 0xe9, 0xf4, 0xb3, 0xd2, 0xe8}, // 21
  {0xd4, 0xe9, 0xf4, 0xb4, 0x49, 0x0c}, // 24
  {0x80, 0xf3, 0xda, 0x42, 0x95, 0xb8}, // 26
  {0x80, 0xf3, 0xda, 0x42, 0xa2, 0xa8}, // 28
  {0xd4, 0xe9, 0xf4, 0xb0, 0xe0, 0xec}, // 29
  {0x88, 0x57, 0x21, 0x94, 0x63, 0x00}, // 31
  {0x80, 0xf3, 0xda, 0x42, 0xb5, 0x68}, // 34
  {0x80, 0xf3, 0xda, 0x42, 0xf7, 0xc0}, // 40
  {0xd4, 0xe9, 0xf4, 0xbc, 0xb2, 0x60}, // …
};
